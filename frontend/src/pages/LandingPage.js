    ...
    <div data-testid="landing-page">
      ...
      <section className="relative min-h-[90vh] flex items-end" data-testid="hero-section">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 pb-20 w-full">
          <p className="rage-overline mb-6 !text-white/70">{c.hero.overline}</p>
          ...
          <p className="mt-8 text-lg text-white/70 max-w-2xl leading-relaxed">{c.hero.body}</p>
          <div className="mt-10 flex flex-wrap gap-4">
            <Link to={c.hero.cta_primary_link || '/private-table'}><Button className="bg-[#DC143C] hover:bg-[#B01030] text-white rounded-none rage-btn-glow h-12 px-8 text-sm tracking-wider uppercase font-semibold" data-testid="hero-explore-btn">{c.hero.cta_primary_text} <ArrowRight className="w-4 h-4 ml-2" /></Button></Link>
            <EnquiryDialog interest="general" title="Talk to Us" trigger={<Button variant="outline" className="border-white/30 text-white hover:bg-white/10 rounded-none h-12 px-8 text-sm tracking-wider uppercase font-semibold" data-testid="hero-enquiry-btn">{c.hero.cta_secondary_text}</Button>} />
          </div>
        </div>
      </section>
      ...
      <section className="py-24 border-t border-gray-100" data-testid="problem-section">
        <div className="max-w-[1400px] mx-auto px-6">
          <p className="rage-overline mb-4">{c.problem.overline}</p>
          <h2 className="text-4xl md:text-5xl font-normal tracking-tight text-gray-900 max-w-3xl mb-6">{c.problem.title}</h2>
          <p className="text-lg text-gray-600 max-w-2xl mb-16 leading-relaxed">{c.problem.body}</p>
      ...
      <section className="py-24 bg-gray-50 border-t border-gray-100" data-testid="focus-section">
        <div className="max-w-[1400px] mx-auto px-6">
          <p className="rage-overline mb-4">{c.focus.overline}</p>
      ...
      <section className="py-24 border-t border-gray-100" data-testid="formats-section">
        <div className="max-w-[1400px] mx-auto px-6">
          <p className="rage-overline mb-4">{c.formats.overline}</p>
          <h2 className="text-4xl md:text-5xl font-normal tracking-tight text-gray-900 max-w-3xl mb-6">{c.formats.title}</h2>
          <p className="text-lg text-gray-600 max-w-2xl mb-16 leading-relaxed">{c.formats.body}</p>
      ...
      <section className="py-24 bg-gray-50 border-t border-gray-100" data-testid="users-section">
        <div className="max-w-[1400px] mx-auto px-6"><div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div><p className="rage-overline mb-4">{c.users.overline}</p><h2 className="text-4xl md:text-5xl font-normal tracking-tight text-gray-900 mb-6">{c.users.title}</h2><p className="text-base text-gray-600 leading-relaxed">{c.users.body}</p></div>
      ...
      <section className="py-24 border-t border-gray-100" data-testid="network-preview-section">
        <div className="max-w-[1400px] mx-auto px-6"><div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div><p className="rage-overline mb-4">{c.network_preview.overline}</p><h2 className="text-4xl md:text-5xl font-normal tracking-tight text-gray-900 mb-6">{c.network_preview.title}</h2><p className="text-base text-gray-600 leading-relaxed mb-8">{c.network_preview.body}</p>
      ...
      <section className="py-24 bg-gray-50 border-t border-gray-100" data-testid="why-different-section">
        <div className="max-w-[1400px] mx-auto px-6 text-center">
          <p className="rage-overline mb-4">{c.why_different.overline}</p>
          ...
          <p className="text-base text-gray-600 max-w-2xl mx-auto mb-16 leading-relaxed">{c.why_different.body}</p>
      ...
      <section className="py-24 border-t border-gray-100" data-testid="cta-section">
        <div className="max-w-[1400px] mx-auto px-6 text-center">
          ...
          <p className="text-base text-gray-600 mb-10 max-w-xl mx-auto">{c.cta.body}</p>
          <div className="flex flex-wrap justify-center gap-4">
            <EnquiryDialog interest="closed-table" title="Request a Closed Table" trigger={<Button className="bg-[#DC143C] hover:bg-[#B01030] text-white rounded-none rage-btn-glow h-12 px-8 text-sm tracking-wider uppercase font-semibold" data-testid="cta-closed-table">{c.cta.cta_primary_text}</Button>} />
            <Link to="/private-table"><Button variant="outline" className="border-gray-300 text-gray-900 hover:bg-gray-100 rounded-none h-12 px-8 text-sm tracking-wider uppercase font-semibold" data-testid="cta-explore">{c.cta.cta_secondary_text}</Button></Link>
          </div>
        </div>
      </section>
    </div>
