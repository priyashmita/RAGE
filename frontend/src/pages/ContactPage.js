...
const D = { hero:{overline:'',title:'',subtitle:'',body:'',image_url:''}, details:{email:'contact@rageforgood.com',note:''}, cta:{title:'',body:''} };
      ...
      {c.hero.title && (
        c.hero.image_url ? (
          <section className="relative h-[60vh] min-h-[400px] flex items-end">
            ...
            <div className="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-8 pb-16 w-full">
