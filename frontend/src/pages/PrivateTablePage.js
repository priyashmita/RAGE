...
export default function PrivateTablePage() {
  ...
  return (
    <div data-testid="private-table-page">
      ...
      {c.flow.title && (
        <section className="py-20 bg-gray-50 border-t border-gray-100"><div className="max-w-[1400px] mx-auto px-6">
          {c.flow.overline && <p className="rage-overline mb-4">{c.flow.overline}</p>}
          <h2 className="text-3xl md:text-4xl font-normal tracking-tight text-gray-900 mb-12">{c.flow.title}</h2>
      ...
      {c.upcoming?.length > 0 && c.upcoming[0].title && (
        <section className="py-20 border-t border-gray-100"><div className="max-w-[1400px] mx-auto px-6">
          <p className="rage-overline mb-8">Upcoming Tables</p>
      ...
      <section className="py-20 border-t border-gray-100"><div className="max-w-[1400px] mx-auto px-6 text-center">
